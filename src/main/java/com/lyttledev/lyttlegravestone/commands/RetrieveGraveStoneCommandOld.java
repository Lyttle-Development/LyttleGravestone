...
public class RetrieveGraveStoneCommandOld implements Command<CommandSourceStack> {
    // Import Economy from Vault
    private static Economy economy = null;
    private static LyttleGravestone plugin = null;

    public static void register(LyttleGravestone lyttlePlugin, Commands commands) {
        ...
        LiteralArgumentBuilder<CommandSourceStack> commandBuilder =
            Commands.literal("retrieve-gravestone")
                ...
                .executes(new RetrieveGraveStoneCommandOld())
